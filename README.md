...
a) Power Bi Desktop-Main Data Visulisation Platform used for report creation.
b) Power Query-Data Transformation and Cleaning Layer for reshaping and preparing the data.
c) DAX(Data Analysis Expression)-Used for calculated Measures,Dynamic Visuals and Conditional Logic.
d) Data Maodeling-Relationship established among tables.

4.Features and Highlights
a) Business Problem
b) Goal of the Dashboard
c) Walk through key Visuals
